...
export interface SignatureAppearanceOptions {
  ...
  page?: number;
  position?: 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right' | 'center' | 'top_left' | 'top_right' | 'bottom_left' | 'bottom_right';
  searchText?: string;
...
export class CertForgeClient {
  ...
  signPdf(sessionId: string, alias: string, pdfBase64: string, options?: SignPdfOptions): Promise<SignPdfResponse>;
